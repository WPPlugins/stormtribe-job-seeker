...
//DO NOT EDIT THIS PLUGIN - EDITERA INTE DETTA TILLÄGG
...
function stdev_job_seeker_init()
{
    ...
    {
        //wp_enqueue_style('stdev-job-seeker', $g_sjs_plug_url.'assets/stdev-custom-posts.css',false,$g_sjs_version,'all');
